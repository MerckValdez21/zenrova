...
class _JournalScreenState extends State<JournalScreen>
  ...
  Future<void> _loadEntries() async {
    ...
    try {
      final entriesData = await _firestoreService.getUserJournalEntries(userProvider.user!.id);
      if (mounted) {
        setState(() {
          _entries.clear();
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Text('Zenrova Journal', style: AppTypography.overline.copyWith(color: AppColors.primary)),
          ),
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            hintStyle: AppTypography.body2.copyWith(color: AppColors.onSurfaceMuted),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Column(
              children: [
                Container(
                  ...
                  child: const Icon(Icons.edit_note_rounded, color: Colors.white, size: 44),
                ),
                ...
                Text(
                  ...
                  style: AppTypography.body2.copyWith(color: Colors.white.withValues(alpha: 0.85), height: 1.6),
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text('Write first entry', style: AppTypography.button.copyWith(color: AppColors.primary)),
                      ],
                    ),
                  ),
                ),
          ...
          // Prompt suggestions
          Text('Writing prompts to get started', style: AppTypography.heading4.copyWith(color: AppColors.onSurface)),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(child: Text(prompt, style: AppTypography.body2.copyWith(color: AppColors.onSurface))),
            const Icon(Icons.arrow_forward_rounded, color: AppColors.onSurfaceMuted, size: 16),
          ],
        ),
      ),
    );
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    ...
                    PopupMenuButton<String>(
                      icon: Icon(Icons.more_horiz_rounded, color: AppColors.onSurfaceMuted, size: 20),
                      ...
                      itemBuilder: (_) => [
                        PopupMenuItem(
                          ...
                          child: Row(children: [
                            ...
                            Text('Edit', style: AppTypography.body2.copyWith(color: AppColors.onSurface)),
                          ]),
                        ),
                        PopupMenuItem(
                          value: 'delete',
                          child: Row(children: [
                            ...
                            const SizedBox(width: 10),
                            Text('Delete', style: AppTypography.body2.copyWith(color: AppColors.error)),
                          ]),
                        ),
                      ],
                      onSelected: (v) {
                ...
                Text(
                  entry.content,
                  style: AppTypography.body2.copyWith(color: AppColors.onSurfaceMuted, height: 1.55),
                  maxLines: 3,
                  overflow: TextOverflow.ellipsis,
                ),
                const SizedBox(height: 14),
                Row(
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.schedule_rounded, size: 12, color: gradient[0]),
                          const SizedBox(width: 4),
                          Text(entry.formattedDate, style: AppTypography.caption.copyWith(color: gradient[0], fontWeight: FontWeight.w600)),
                        ],
                      ),
                    ),
                    const Spacer(),
  ...
  void _updateEntry(int index) async {
    ...
    try {
      ...
      if (mounted) {
        ...
        _showSuccessSnack('Entry updated!');
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  void _deleteEntry(int index) async {
    ...
    try {
      await _firestoreService.deleteJournalEntry(_entries[index].id);
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Row(children: [
              ...
              const SizedBox(width: 10),
              Text('Entry deleted', style: AppTypography.body2.copyWith(color: Colors.white)),
            ]),
            backgroundColor: AppColors.error,
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: AppTypography.heading4.copyWith(color: AppColors.onSurfaceMuted.withValues(alpha: 0.6)),
              filled: true,
              fillColor: const Color(0xFFF7F5FF),
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide.none),
              enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: const BorderSide(color: Color(0xFFEDE9FF), width: 1.5)),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: AppTypography.body1.copyWith(color: AppColors.onSurfaceMuted.withValues(alpha: 0.6)),
              filled: true,
              fillColor: const Color(0xFFF7F5FF),
              border: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide.none),
              enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: const BorderSide(color: Color(0xFFEDE9FF), width: 1.5)),
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Center(child: Text('Cancel', style: AppTypography.button.copyWith(color: AppColors.primary))),
                  ),
                ),
              ),
                    ...
                    child: Center(
                      child: Row(
                        ...
                        children: [
                          ...
                          const SizedBox(width: 8),
                          Text(isEditing ? 'Update' : 'Save Entry', style: AppTypography.button.copyWith(color: Colors.white)),
                        ],
                      ),
                    ),
                  ),
